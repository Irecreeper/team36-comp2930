      ...
      <div class="panel top">
        <div id="holder">
          ...
          <div id="main-content" class="container">
            ...
            <p>
              This website was built using HTML5, CSS3, JavaScript, Bootstrap
              and ReactJS on the front-end, while MongoDB and NodeJS were used
              for the back-end. Our website is hosted on Amazon Web Services. It
              was also specifically designed for BCIT’s second-term Projects
            ...
            <p>
              ...
              news that our city has to offer. Normally, if one is concerned
              with environmental topics, it can be a pain to jump from website
              to website to find out that is happening with our environment.
            </p>

            <p>
              We hope to alleviate those problems with VEN- your local news
              aggregate for all things green! With all of these articles
              condensed onto one website, it’ll be far easier to see the bigger
              picture of our environment, and how we fit into EcoCity’s
              standards for a truly green city.
            </p>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                />
                <p>
                  Joel is a hard worker who did labour jobs for three years
                  before coming to BCIT so that he could join the growing
                  industry of programmers. He’s a fan of gaming, especially
                  platformer games.
                </p>
              </div>
              <div class="col-md-4">
              ...
              <div class="col-md-4">
                ...
                />
                <p>
                  Alec is an approachable person that loves to learn and work.
                  He strives to learn new things every day, and become the best
                  that he can be. In his spare time, he loves to hang out with
                  friends or play video games like DotA.
                </p>
              </div>
              <div class="col-md-4">
                ...
                <p>
                  ...
                  soccer. In his spare time, he also enjoys playing tabletop
